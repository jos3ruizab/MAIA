import { LayoutDashboard, MessageSquare, Lightbulb, Landmark, Bot } from 'lucide-react'

const footerItems = [
  { label: 'Dashboard', icon: LayoutDashboard, active: false },
  { label: 'Foros DAO', icon: MessageSquare, active: false },
  { label: 'Iniciativas', icon: Lightbulb, active: true },
  { label: 'Tesorería', icon: Landmark, active: false },
]
