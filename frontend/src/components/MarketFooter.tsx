import { Landmark, Shield, BarChart3, Award, Bot } from 'lucide-react'

const footerItems = [
  { label: 'Distribución', icon: Landmark, active: false },
  { label: 'Ciudadanía', icon: Shield, active: false },
  { label: 'Estadísticas', icon: BarChart3, active: true },
